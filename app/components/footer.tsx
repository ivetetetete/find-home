...
export default function Footer() {
    ...
    return (
        <footer className="flex flex-col p-4 bg-blue-800 border-t w-full">
            ...
            <div>
                <p className="font-semibold my-3 text-lg">Contactan´s</p>
                <div className="space-y-2">
                    <div className="flex items-center gap-x-2">
                        <Phone size={18} className="text-gray-300 inline-block" />
                        <p className="text-base text-gray-300">Nerea Sanjurjo: 644 365 887</p>
                    </div>
                    <div className="flex items-center gap-x-2">
